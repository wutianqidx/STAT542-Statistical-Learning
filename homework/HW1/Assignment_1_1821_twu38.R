...
#Output pdf
pdf('AssignmentOutput_1_1821_twu38.pdf')
...
legend("bottomleft", pch = c(1,1,1,2,2), col = c("red", "blue","purple","red","blue"), 
       legend = c("KNN test", "KNN train", "Bayes","Linear test", "Linear error"))
dev.off()
