...
##Visualizaiton
I used R to read in a list of reviews the output will color the negative/positive words in the review. Positive words are colored by blue and negative words are colored by red. Following are examples for the first three reviews from the dataset.
